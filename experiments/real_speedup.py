...
def dummy_training(model, optimizer, batch_size):
...
if __name__ == "__main__":
    ...
    np.save(f"real_data/small_net_time_result_{size}.npy", snr)
    np.save(f"real_data/large_net_time_result_{size}.npy", lnr)
